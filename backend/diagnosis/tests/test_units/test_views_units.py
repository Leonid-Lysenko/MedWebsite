...
from diagnosis.views import get_ml_symptoms  # Заменили load_symptoms на новую функцию
...
def test_home_view_context_structure(mock_get_symptoms, mock_render, mock_symptoms_list_fixture, factory):
    """
...
@patch("diagnosis.views.render")
@patch("diagnosis.views.get_ml_symptoms")
def test_home_view_symptoms_grouping_logic(mock_get_symptoms, mock_render, mock_symptoms_with_special_chars, factory):
...
@patch("diagnosis.views.get_ml_symptoms")
@patch("diagnosis.views.get_disease_info_from_db")
def test_predict_success_flow(mock_get_db_info, mock_get_symptoms, mock_model, factory, predict_request_data):
    ...
    mock_get_db_info.return_value = {"description": "Desc", "treatment": "Treat", "severity": "low"}
...
def test_predict_performance(client):
    ...
    with (
        ...
        mock_db_info.return_value = {"description": "Desc", "treatment": "Treat", "severity": "low"}
